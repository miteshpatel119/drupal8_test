...
namespace Drupal\custom_api_module\Plugin\rest\resource;
...
class ApiKeyResource extends ResourceBase {
  ...
  public function get($id = null) {
    $current_uri = array_reverse(explode('/', \Drupal::request()->getRequestUri()));
    $api_key = $current_uri[1]; // Api key value
    $nid = $current_uri[0]; // Node id value
